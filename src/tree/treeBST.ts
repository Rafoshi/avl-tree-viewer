...
class TreeNode {
    ...
    constructor(value: number, right: TreeNode | null = null, left: TreeNode | null = null, height: number = 0) {
        this.value = value;
        this.left = left;
        this.right = right;
    }
...
class TreeBST {
    ...
    private inOrderTraversalNode(root: TreeNode | null | undefined, values: TreeReturn[]) {
        if (root === null)
            return;
